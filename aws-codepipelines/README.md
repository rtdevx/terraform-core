...
| <a name="input_codepipeline_github_repository"></a> [codepipeline\_github\_repository](#input\_codepipeline\_github\_repository) | CodePipeline GitHub repository | `string` | n/a | yes |
